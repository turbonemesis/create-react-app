...
## Development of this forked repo

`cd into packages/react-error-overlay && npm i` first, before you `cd ../.. && npm i`, to get around the postinstall script errors on initial clone.
